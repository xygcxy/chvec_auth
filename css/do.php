<?php
	...
	exec("/var/www/chvec_auth/all.sh $validCode {$formPostData['validDate']} $videoId '{$formPostData['authPurpose']}' $validPath {$formPostData['authFormat']} > /dev/null & ");
?>
<style type="text/css">
	.authBody p {

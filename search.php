...
$sql="SELECT * from `video` where `title_cn` like '%".$_POST['searchvideo']."%' LIMIT $start_num, $page_num";
  ...
  while ($result_row = mysql_fetch_assoc($result)) {
    echo <<<VIDEO
        <div class="video">
          <video width="352" height="264" controls="controls" poster="../chinavec/data-storage/video/poster/h/{$result_row['id']}.jpg" preload="none">

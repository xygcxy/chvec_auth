...
time=$8
	...
	/root/bin/ffmpeg -i $video_path -vf "movie=/var/www/chvec_auth/img/vec1.png, scale=100:30 [movie]; [in] [movie]overlay=main_w-overlay_w-10:main_h-overlay_h-10:enable=lt(mod(t\,$period)\,$time) [out]" -qscale 3 /var/www/chvec_auth/tmp/$ID.mpg
